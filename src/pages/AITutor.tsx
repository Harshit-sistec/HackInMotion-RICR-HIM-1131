...
const WELCOME: ChatMessage = {
  id: 'welcome',
  role: 'ai',
  content: "Hi! I'm Nova, your AI study tutor. Ask me anything about your subjects — I'll explain it at your level, give examples, or quiz you.",
...
export function AITutor() {
  ...
  const send = async (text: string) => {
    ...
    const userMsg: ChatMessage = { id: randomId('msg'), role: 'user', content: text, timestamp: new Date().toISOString() };
    ...
    try {
      ...
      setMessages((m) => [
        ...m,
        { id: randomId('msg'), role: 'ai', content: err instanceof Error ? err.message : 'Something went wrong.', timestamp: new Date().toISOString() },
      ]);
    } finally {
      setLoading(false);
    }
          ...
          <div className="space-y-5">
            <Card padding="lg">
              ...
              <ul className="space-y-3 text-sm text-ink-600 dark:text-ink-300">
                ...
                <li className="flex gap-2"><Volume2 size={16} className="mt-0.5 shrink-0 text-accent-500" /> Tap the speaker on any reply to hear it spoken.</li>
