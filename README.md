...
Exam prep for competitive/academic exams (NEET, JEE, and similar) is largely one-size-fits-all:
students get static syllabus and generic question banks with no adaptation to their actual weak
areas, no real feedback loop from their own mock-test performance, and no low-friction way to study
alongside peers preparing for the same exam. Most "study apps" either require a human tutor
(expensive, doesn't scale) or are just static content libraries with no intelligence behind them.
